...
<script src="js/report_weather.js"></script>
...
<body>
	<div class="container" style="margin-bottom: 2rem;">
		...
		<div class="form-group" style="float: left;  margin-right: 20px;">
			<label for="period" class="form-label" style="display: block;">특정일 선택시, 년/월로 자동 변환</label>
			<div id="period" name="period" style="display: flex;">
				<input type="text" id="datepick" style="width:140px; height:40px; 
				border-radius:5px; margin-right: 20px;" placeholder="특정일 선택">
			</div>
		</div>
		<button class="btn btn-outline-primary" id="search_report" style="margin-top:2rem;">조회</button>
	</div>
	<div style="width:700px; height:800px;">
		<canvas id="report" width="700" height="800"></canvas>
	</div>
</body>
